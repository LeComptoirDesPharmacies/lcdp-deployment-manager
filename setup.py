...
setup(
    ...
    version='1.2.1rc-3775-2',  # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/LeComptoirDesPharmacies/lcdp-deployment-manager/archive/v1.2.1rc-3775-2.tar.gz',
