...
setup(
    ...
    version='1.0.27',  # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/LeComptoirDesPharmacies/lcdp-deployment-manager/archive/v1.0.24.tar.gz',
